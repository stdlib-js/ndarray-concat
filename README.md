...
```javascript
concat = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-concat@v0.1.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/ndarray-concat/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/ndarray-concat/actions/workflows/test.yml?query=branch:v0.1.1
